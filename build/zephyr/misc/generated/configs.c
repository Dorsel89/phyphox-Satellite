...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PHYPHOX_SATELLITE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPR_PRESSURE_RANGE_0025, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPR_PRESSURE_UNIT_P, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPR_TRANSFER_FUNCTION_A, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHTCX, 1);
